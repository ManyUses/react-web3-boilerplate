...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.HARMONY]: [...WRAPPED_NATIVE_ONLY[ChainId.HARMONY], HARMONY.USDC, HARMONY.USDT, HARMONY.WETH, HARMONY.WBTC],
  ...
  [ChainId.CELO]: [...WRAPPED_NATIVE_ONLY[ChainId.CELO], CELO.mCUSD, CELO.mCELO, CELO.mcEURO, CELO.cEUR],
}
