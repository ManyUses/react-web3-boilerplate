...
export const MATIC: { [key: string]: Token } = {
  ...
  SUSHI: new Token(ChainId.MATIC, '0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a', 18, 'SUSHI', 'FungyProofToken'),
...
export const SUSHI: ChainTokenMap = {
  ...
  // [ChainId.HECO]: new Token(ChainId.HECO, SUSHI_ADDRESS[ChainId.HECO], 18, 'SUSHI', 'FungyProofToken'),
}
