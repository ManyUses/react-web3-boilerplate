  ...
  return (
    <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal} maxWidth={768}>
      ...
      <div className="mb-6 text-lg text-primary">
        You are currently browsing <span className="font-bold text-black">ManyUses</span>
      ...
      <div className="grid grid-flow-row-dense grid-cols-1 gap-5 overflow-y-auto md:grid-cols-2">
        {[
          ...
          if (chainId === key) {
            return (
              <button key={i} className="w-full col-span-1 p-px rounded border border-black">
          ...
          return (
            <button
              ...
              className="flex items-center w-full col-span-1 p-3 space-x-3 rounded cursor-pointer hover:bg-gray-100"
            >
